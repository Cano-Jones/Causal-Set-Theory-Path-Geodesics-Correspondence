...
This example script shows the path-geodesic correspondence in an Spherical background for a timelike trajectory.
"""
...
if __name__ == "__main__":
    ...
    simCauset = CausetSimulation(Metric=g, TimeRange=(0,4), SpaceRange=(-0.99,0.99), PointNumber=350, Divisions=(150,150))

    #For the continuum geodesic we employ the following code
    simContinuum = ContinuumSimulation(Metric=g, source=(0,0.3), SpacialVelocity=-0.95, tau_span=linspace(0,100,1000), g_type='timelike')
